...
#: Die Pflichtbelegrollen je Gate und Scope (ADR-009) wohnen seit dem
#: Entscheid des Maintainers 2026-09-22 (Befund T26-03, Weg 2) in
#: ``models.belegrollen`` — der Schicht fuer paketuebergreifend lesbare
#: Vertraege. Gate UND Betriebseingang lesen denselben Vertrag; ``fall``
#: beherbergte ihn nur und nutzte ihn nie. ``FALL_SCOPES`` bleibt hier
#: (Manifest-Vokabel); eine Ratsche haelt beide Scope-Listen gleich.
