...
| **Merkmalsdimensionen eines uebernommenen Tarifs in der Bestands-Config** | Baldrian-Lauf 2026-08-29 | Die Config traegt je Generation EINEN Parametersatz; die uebernommene TG2015 hat sechs Zellen (tarifart x status). Der Bestandsbericht bewertet den zugewanderten Bestand deshalb mit einer Zelle. Fuer die Abnahmegroessen ohne Wirkung — dort rechnet die Spez je Vertrag —, fuer die Bestandskennzahlen eine benannte Ungenauigkeit. |
| **Stornoabzug nach Beitragsabsetzung** | Baldrian-Lauf 2026-08-29 | Fuer den geteilten Vertrag rechnet das Zielsystem den Abzug vertragsweit auf der neuen Gesamtsumme. Das ist EINE vertretbare Lesart der Ziffer 3.1; die abgebende Gesellschaft konnte ihre eigene nicht mehr herleiten (Aktuarielle Notiz 2026/05), sechs geprueft Lesarten trafen keine alle. Solange das Tarifwerk die Frage nicht regelt, gehoert sie je Tarifplan festgelegt — bis dahin traegt die Plausibilitaetspruefung. |
...
| **Bewegungsrechnung eines uebernommenen Bestands** | Baldrian-Lauf 2026-08-29 | Die Uebernahme rechnet die PEX-Buchung eines mitgebrachten beitragsfreien Zustands selbst, weil die Vorgeschichte keine Betraege fuehrt (9.14). Das ist konstruktiv richtig, aber die Buchung ist damit eine Rechnung des AUFNEHMENDEN Unternehmens und kein Beleg der Gegenseite — im Bewegungskonto steht sie neben Buchungen, die aus echten Ereignissen stammen. Ob das im Bericht kenntlich sein muss, ist offen. |
