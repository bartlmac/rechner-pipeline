...
| **Herabsetzung ausserhalb des ungeteilten Tracks** | Baldrian-Lauf 2026-08-29, praezisiert 2026-08-30 | Der Tarifplan der PLV FUEHRT die Herabsetzung bereits: Zielverfahren verlustfrei, StoAb und RKW vertragsweit auf die neue Gesamtsumme, Grenzen je Vertrag (docs/tarifplaene/klv.md). Er beschraenkt sie aber ausdruecklich auf den ungeteilten beitragspflichtigen Track ohne Scheiben — fuer eine Herabsetzung nach dynamischer Erhoehung oder auf einem geteilten Vertrag ist die Ausgestaltung offen. Das ist der verbleibende Rest; die ZUORDNUNG ist entschieden: Eine eigene Teilkuendigung des Zielsystems ist eine Zusage und gehoert in den Tarifplan, waehrend der Abzug eines UEBERNOMMENEN Vertrags eine Rekonstruktion fremder Praxis bleibt und Fall-Eigenschaft ist (die abgebende Gesellschaft hat der Werthoehe nach nie etwas zugesagt, Aktuarielle Notiz 2026/05). |
