...
| **Stornoabzug nach Beitragsabsetzung: die ZUKUNFT gehoert in den Tarifplan** | Baldrian-Lauf 2026-08-29, entschieden 2026-08-30 | Die Frage zerfaellt in zwei, und nur eine ist offen. HISTORISCH — fuer die 35 uebernommenen Absetzungen — bleibt der Abzug eine EIGENSCHAFT DES FALLS: Das Zielsystem rekonstruiert konstruktiv, was die abgebende Gesellschaft getan hat, und die hat der Werthoehe nach nichts zugesagt (Aktuarielle Notiz 2026/05). Es gibt dort nichts zu garantieren, weil nie etwas garantiert war. KUENFTIG — sobald das Zielsystem eine eigene Teilkuendigung rechnet — ist das Ergebnis eine Zusage an den Versicherungsnehmer und gehoert als solche in den Tarifplan, nicht in einen Laufparameter. Offen ist damit nur noch die Ausgestaltung je Tarifplan; die Zuordnung steht. |
