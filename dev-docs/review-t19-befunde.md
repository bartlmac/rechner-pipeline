...
| T22-11 Verankerung endet am Uebernahmeeingang | hoch | betrieb | **Stufe 1 behoben** cc55192 — Verankerung im Stand, Protokoll und Seite weisen "registriert, nicht angewandt" aus. **Stufe 2 behoben** auf Branch `freischaltung` (Fachentscheid des Maintainers 2026-09-07, dev-docs/freischaltung-uebernommener-bestand.md): Tarifwerks-Schalter je Generation, Uebernahme materialisiert den Anfangszustand, Fuehrung rechnet ihn samt Korrekturschicht, Fuehrungsprobe als Pflichtbeleg von A-M4. Der eigentliche Befund war groesser als der Review-Punkt: die Fuehrung rechnete eine andere Welt als die Abnahmen (550 von 834 Stammsummen, 1,72 statt 3,71 Mio EUR beitragsfreier Bestand). Offen: Fall Lauf 2 neu erzeugen und zeichnen (Schritt 8), Betrieb neu aufsetzen (Schritt 9). |
