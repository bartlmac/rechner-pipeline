...
| **T24-04 Teil 2 (Block C)** | ERLEDIGT. Entscheid des Maintainers 2026-09-16: externer Anker plus Zeichnung des Exports. Gebaut ist der Anker (`betrieb/anker.py`, Paketschema 4): Der Export legt den Hash der letzten Protokollzeile im Fall-Datenraum ab, das Paket NENNT den Satz, der Konsument prueft dagegen. Der Klassen-Test baut ein in sich stimmiges gefaelschtes Paket — es besteht jede paketinterne Pruefung und faellt am Anker. Die Zeichnung des Exports ist als offener Punkt vermerkt: Sie braucht eine Festlegung, wer zeichnet. |
